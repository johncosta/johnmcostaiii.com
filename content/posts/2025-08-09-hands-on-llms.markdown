...
Reranking can be used to improve the results of a search by using a more powerful model to rerank the results of a
simpler model.
...
* __Mean Average Precision (MAP)__: A metric used to evaluate the performance of information retrieval systems, measuring the average precision across multiple queries.
